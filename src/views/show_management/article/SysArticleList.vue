          ...
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="文章类型">
                <j-dict-select-tag v-decorator="['articleType', {}]" :triggerChange="true" placeholder="请选择文章类型"
                                   dictCode="article_type"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="文章状态">
                <j-dict-select-tag v-decorator="['articleState', {}]" :triggerChange="true" placeholder="请选择文章状态"
