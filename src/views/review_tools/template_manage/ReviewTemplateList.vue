<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <reviewTemplate-modal ref="modalForm" @ok="modalFormOk"></reviewTemplate-modal>
  </a-card>

</template>

<script>
import ReviewTemplateModal from './modules/ReviewTemplateModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import constantCfgMixin from '@/mixins/constant.cfg'
import antMixin from '@/mixins/ant-mixin'

export default {
  name: 'ReviewTemplateList',
  ...
  data () {
    return {
      ...
      */
      ...
      url: {
        list: '/review/reviewTemplate/list',
        delete: '/review/reviewTemplate/delete',
